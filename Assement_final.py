...
class Game:
   ...
   #-----------------------------------------------FRAMES------------------------------------------------------- 
    ...
    def home_frame(self):
        ...
        button_play = Button(frame, text = "Play", font = "helvetica 20 bold", bg = "lightpink" , relief = "solid", 
        ...
        button_help = Button(frame, text = "How to Play", font = "helvetica 20 bold", bg = "lightpink" , relief = "solid", 
    ...
    def help_frame(self):
        ...
        #window design
        banner_help = Label(frame, text = "Welcome to Donut Clicker!", font = "helvetica 30 bold", bg = "lightblue")
        banner_help.grid(column = 0, row = 0, sticky = "WE", ipadx=20)

        what_label = Label(frame, text = '''
                           This game is a basic clicker game that works by you the user clicking on the big donut to earn sprinkles.
        ...
        that provide you with a passive income of sprinkles.
                    ...
                    Click Power:
                    To increase your click power you can go to the upgrade menu and select the "increase click power" option after clicking this you can calculate the cost.
                    of the upgrade and confirm your purchase.

                    Workers:
                    To purchase workers just select the purchase workers option and you will be shown how much it costs to purchase another worker.

                           

                    Saving:
                    Make sure you save before leaving! you can do this by pressing the save and quit button before closing the program. If this button is not clicked then 
                    your progress may be lost

                    You can view the top 5 players by clicking the leaderboard button. AIM TO BE THE BEST AND HAVE FUN!
       ...
       ''',
        ...
        back_button = Button(frame, text = "Back", font = "helvetica 20 bold", bg = "lightpink" , relief = "solid",
    ...
    def login_frame(self):
        ...
        #window design
        banner_login = Label(frame, text = "Login to Donut Clicker", font = "helvetica 30 bold", bg = "lightblue")
        banner_login.grid(column = 0, row = 0, sticky = "NSEW", ipadx=20, pady = 60,columnspan = 2)
        

        username_label = Label(frame, text = "Username", font = "helvetica 20 bold", bg = "lightblue")
        ...
        password_label = Label(frame, text = "Password", font = "helvetica 20 bold", bg = "lightblue")
        ...
        login_button = Button(frame, text = "Login", font = "helvetica 20 bold", bg = "lightpink" , relief = "solid", command = lambda: self.login()) #when clicked it initiates the login method
        login_button.grid(column = 0, row = 3, ipadx=20, pady = 10,columnspan = 2)

        home_button = Button(frame, text = "Home", font = "helvetica 20 bold", bg = "lightpink" , relief = "solid",
                             command = lambda: self.show_frame("homepage"))  #gives "homepage" as name to show_frame method which means when this button is clicked the home frame is raised
        home_button.grid(column = 0, row = 4, ipadx=20, pady = 10, columnspan = 2)
  
        self.incorrect_label = Label(frame, text = "", font = "helvetica 20 bold", bg = "lightblue")
        self.incorrect_label.grid(column = 0, row = 5, ipadx=20, pady = 40,columnspan = 2)

        create_account_button = Button(frame, text = "Create New Account", font = "helvetica 20 bold", bg = "lightpink" , relief = "solid", command = lambda: self.show_frame("createpage"))
    ...
    def game_frame(self):
        ...
        user_sprinkles = Label(frame, 
                              ...
                              font = "helvetica 30 bold", bg = "lightblue")
        ...
        leaderboard_button = Button(frame, text = "Leaderboard", font = "helvetica 30 bold", bg = "lightpink" , relief = "solid", command = self.display_top_players)
        leaderboard_button.grid(column = 0, row = 2, ipadx=20)

        #save button
        save_button = Button(frame, text = "Save & Quit", font = "helvetica 20 bold", bg = "lightpink" , relief = "solid",command = self.quit)
        save_button.grid(column = 1, row = 0,  pady = 10)


        #upgrade store button
        store_button = Button(frame, text = "Upgrade store", font = "helvetica 20 bold", bg = "lightpink" , relief = "solid",
                              command = self.popup)
    ...
    def new_account_frame(self):
        ...
        #window design
        banner_login = Label(frame, text = "Create Account", font = "helvetica 30 bold", bg = "lightblue")
        banner_login.grid(column = 0, row = 0, sticky = "NSEW", ipadx=20, pady = 60,columnspan = 2)
        ...
        create_button = Button(frame, text = "Create", font = "helvetica 20 bold", bg = "lightpink" , relief = "solid", 
        ...
        self.create_label = Label(frame, text = "", font = "helvetica 20 bold", bg = "lightblue")
        ...
        login_page_button = Button(frame, text = "Login Page", font = "helvetica 20 bold", bg = "lightpink" , relief = "solid", command = lambda: self.show_frame("loginpage"))
    ...
    def clickincrease_upgrade(self):
        ...
        #window design
        increase_label = Label(self.click_increase_popup, text = "How much would you like to earn per click:", font = "helvetica 10 bold")
        ...
        earn_per_click_label = Label(self.click_increase_popup, text = f"current sprinkles earned per click: {self.clickamount}", font = "helvetica 10 ")
        earn_per_click_label.grid(column = 0, row = 2, sticky = "NSEW")

        self.cost_label = Label(self.click_increase_popup, text = "", font = "helvetica 10 ")
    ...
    def cost_click(self):
        ...
        if self.entrybox_sprinklesperclick.get().isdigit():
            #variables
            self.cost_amount = (int(self.entrybox_sprinklesperclick.get())*5)**2 #cost of the upgrade
    ...
    def set_click(self):
        ...
        if self.entrybox_sprinklesperclick.get().isdigit():
            #variables
            self.cost_amount = (int(self.entrybox_sprinklesperclick.get())*5)**2 #sets cost amount again incase user changes entered value
    ...
    def worker_upgrade(self):
        ...
        purchase_worker = Button(self.worker_upgrade_popup, text = "Purchase", font = "helvetica 10 bold", command = lambda: self.purchase_worker()) #when clicked starts purchase_worker() method
    ...
    def login(self):
        ...
        elif self.username == "" or pass_to_check == "": #checks if fields are left blank
    ...
    def popup(self):
        ...
        #window design
        popup_label = Label(popup, text = "Upgrade Store", font = "helvetica 20 bold", bg = "lightpink")
        popup_label.grid(column = 0, row = 0, sticky = "NSEW")

        upgrade_button1 = Button(popup, text = "Increase Click Power" , bg = "lightblue", relief = "solid", command = self.clickincrease_upgrade)
        upgrade_button1.grid(column = 0, row = 1, pady = 5)

        upgrade_button2 = Button(popup, text = "purchase workers", bg = "lightblue", relief = "solid",command = self.worker_upgrade)
        upgrade_button2.grid(column = 0, row = 2, pady = 5)

        close_button = Button(popup, text = "close", bg = "lightblue", relief = "solid", command = popup.destroy)
    ...
    def display_top_players(self):
        ...
        banner = Label(popup, text = "Leaderboard", font = "helvetica 20 bold", bg = "lightpink")
    ...
    def new_user(self):
        '''Method is used to ceate accounts for new users'''
        ...
        if self.username in self.users:#checks if username is already being used
            self.create_label.configure(text = "username already exists")

        elif self.username == "" or password == "":#checks if fields are blank
            self.incorrect_label.configure(text = "Do not leave fields blank")
